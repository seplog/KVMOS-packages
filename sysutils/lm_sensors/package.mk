...
post_makeinstall_target() {
  mkdir -p $INSTALL/usr/config
    mv $INSTALL/etc/sensors3.conf $INSTALL/usr/config/
    ln -sf /storage/.config/sensors3.conf $INSTALL/etc/

  rm -f $INSTALL/usr/sbin/{sensors-detect,isadump,isaset}
  rm -f $INSTALL/usr/bin/sensors-conf-convert
}
